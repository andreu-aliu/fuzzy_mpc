...
[anfis_direct.vy.fis, trainError, ~, fis_val, valError] = anfis([Xn_train Y_train(:,1)], opt);
...
[anfis_direct.r.fis, trainError, ~, fis_val, valError] = anfis([Xn_train Y_train(:,2)], opt);
