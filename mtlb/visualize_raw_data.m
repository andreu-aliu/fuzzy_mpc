%% Inspect one raw rosbag and validate its model-identification data
...
save_script_figures('visualize_raw_data',overview_figure);
...
save_script_figures('visualize_raw_data',timing_figure);
...
save_script_figures('visualize_raw_data',raw_figure);
...
save_script_figures('visualize_raw_data',physical_figure);
...
save_script_figures('visualize_raw_data',heading_figure);
...
save_script_figures('visualize_raw_data',filter_figure);
...
save_script_figures('visualize_raw_data',lag_figure);
